      ...
      children=[
        ...
        html.Div(
          ...
          children=[
            ...
            html.Div(
              className='row',
              children=['CoB School CES {} (Mean of Courses with reliable data)'.format(measure.upper())],
        ...
        html.Div(
          ...
          children=[
            dcc.Graph(
              ...
              figure=generate_school_ces_pd_course_mean_table(df_school_course_count, start_year, end_year, measure),
              style={'margin': 0,
                     'margin-top': 0,
                     'margin-left': 250,
                     'margin-right': 0,
