...
template = 'PLO_CLO_alignment_Feb25_temp.xlsx'
...
for i_prg, prg in df_programs[60:70].iterrows():
  # initiate counters
  j_plo = 2
  j_mapping = 2
  j_clo = 2
  ...
  save_filename = 'Feb25\\PLO_CLO_alignment_{}_{}_Feb2019.xlsx'.format(prg['school_abbr'], prg['program_code'])
