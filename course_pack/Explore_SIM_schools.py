...
def get_course_sim_ces_data(cur, tbl='vw100_course', schema='sim_ces'):
  # Returns a dataframe with SIM CES data for courses in course list
  qry = ' SELECT \n' \
        "   year, semester, concat(year, ' S', semester) AS sem, school, course_code, course_name, staff_type, " \
...
def get_course_sim_ces_data_2(cur, tbl='vw101_course', schema='sim_ces'):
  # Returns a dataframe with SIM CES data for courses in course list
  qry = ' SELECT \n' \
        "   year, semester, concat(year, ' S', semester) AS sem, school, course_code, course_name, " \
        '   responses, population, \n' \
        '   subject_content, \n' \
        '   lecturer_effectiveness, \n' \
        '   course_satisfaction \n ' \
...
df = get_course_sim_ces_data(cur=postgres_cur)
...
df2 = get_course_sim_ces_data_2(cur=postgres_cur)
