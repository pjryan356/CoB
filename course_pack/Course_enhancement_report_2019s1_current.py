...
def make_course_pack(course_code):
  ...
  ## Not the first page header is not included as it forms part of the selection box
  ...
  child = [
    ...
    # Second Page - Student Distributions and Additional Information
    html.Div(
      [
          ...
          children=[
            ...
            html.Div(
              ...
              [
                ...
                html.P(['Each of the six GTS questions is measured against a 5-point scale ranging from'
                ...
                html.P(['The GTS percent agree is calculated by taking the sum of student responses'
                        ' that "Agree" or "Strongly Agree" with any GTS question for any teacher'
                ...
                html.P(['The OSI and GTS range from 0 to 100%.'],
                       style={'textAlign': 'left',
                              'font-size': 16,
                              'color': rc.RMIT_Black,
                              'font-weight': 'normal',
