...
directory = 'H:\\Data\\CoB Database\\CES\\Course_program\\Percent Agree\\'
...
# into database
def upload_course_prog_data_from_excel(directory, filename, engine, tbl_name='tbl_course_program_post2018',
                                       schema='ces'):
